...
namespace Cateye
{
	namespace RasterCompiler
	{
		...
		public:
			...
			return 		void
			*/
			void LonLatToMeters(double lon, double lat, 
				double& mx, double& my);
			...
			return 		void
			*/
			void LonLatToTile(double lon, double lat, int zoom, 
				int& tx, int& ty);
			...
			return 		void
			*/
			void MetersToLonLat(double mx, double my, 
			...
			\return 	void
			*/
			void PixelsToMeters(double px, double py, int zoom, 
				double& mx, double& my);
			...
			\return 	void
			*/
			void MetersToPixels(double mx, double my, int zoom, 
				double& px, double& py);
			...
			*/
			...
			\return 	void
			*/
			void PixelsToRaster(double px, double py, int zoom, 
				double& rx, double& ry);
			...
			\return 	void
			*/
			void RasterToPixels(double rx, double ry, int zoom, 
				double& px, double& py);
			...
			\return 	void
			*/
			void MetersToTile(double mx, double my, int zoom, 
				int& tx, int& ty);
			...
			*/
			...
			/**!brief 	Maximal scaledown zoom of the pyramid closest to the
			pixelSize.
			...
			*/
			void GoogleTile(int tx, int ty, int zoom, 
				int& gx, int& gy);
